...
let UsersController = class UsersController {
    ...
    create(t, body) { return this.svc.create(t, body); }
    update(t, id, body) { return this.svc.update(t, id, body); }
    deactivate(t, id) { return this.svc.deactivate(t, id); }
};
exports.UsersController = UsersController;
__decorate([
    (0, common_1.Get)(),
    (0, decorators_1.Roles)('bank_admin', 'super_admin'),
