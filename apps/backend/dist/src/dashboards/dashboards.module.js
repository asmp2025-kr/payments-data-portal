...
exports.DashboardsModule = DashboardsModule = __decorate([
    (0, common_1.Module)({ imports: [typeorm_1.TypeOrmModule.forFeature([])], controllers: [dashboards_controller_1.DashboardsController], providers: [dashboards_service_1.DashboardsService], exports: [dashboards_service_1.DashboardsService] })
], DashboardsModule);
