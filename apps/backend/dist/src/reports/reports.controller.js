...
let ReportsController = class ReportsController {
    ...
    getReports(t, dto) { return this.svc.getReports(t, dto); }
    getRuns(t, reportId) { return this.svc.getRuns(t, reportId); }
    generate(t, u, body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "getRuns", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('runs/:runId/download'),
