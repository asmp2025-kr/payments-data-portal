...
const clearing_controller_1 = require("./clearing.controller");
...
exports.ClearingModule = ClearingModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [clearing_controller_1.ClearingController],
        providers: [clearing_service_1.ClearingService],
        exports: [clearing_service_1.ClearingService],
    })
], ClearingModule);
